...
def initialise():
    ...
    if conf_dict['local_mode']:
        conf_dict['src_hotel_searches'] = '/Users/username/Downloads/propertyAvailabilityRS'
        conf_dict['src_rates_lookup_deduped'] = '/Users/username/Downloads/sw_rate_to_top_client_lookup_deduped'
        conf_dict['output_base_path'] = '/Users/username/Downloads/'
    else:
        ...
        conf_dict['src_rates_lookup_deduped'] = '/user/username/sw_rate_to_top_client_lookup_deduped'
        conf_dict['output_base_path'] = 'hdfs:///user/username/'
